...
class ModelService:
    ...
    def get_llm_model(self, model_name="gemini-2.5-pro"):
        """
        This function is used to instantiate a ChatGoogleGenerativeAI model.

        Args:
            model_name (str, optional): The name of the model to be loaded. Defaults to "gemini-2.5-pro".

        Returns:
            ChatGoogleGenerativeAI: An instance of the ChatGoogleGenerativeAI class representing the generative AI model.
        """
        # Pass the API key explicitly to ensure correct authentication
...
if __name__ == "__main__":
    ...
    llm = service.get_llm_model("gemini-2.5-pro")  # Always use a supported Gemini model!
